...
public class SwaggerConfiguration {
  ...
  public OpenAPI openAPI() {
    return new OpenAPI().addSecurityItem(new SecurityRequirement().addList("Basic auth"))
        .components(
            new Components().addSecuritySchemes("Basic auth", createAPIKeyScheme()))
        .info(apiInfo());
  }
  ...
  private Info apiInfo() {
    return new Info().title("Authentication Service Api Doc").version("1.0.0")
